...
{
	$sql = "SELECT * FROM product INNER JOIN artist ON product.artist_id = artist.artist_id  WHERE product.status='Active' and product.quantity>1 AND artist.state_id='$_GET[state]' and artist.country_id='$_GET[country]' and artist.city_id='" . $_GET['city'] . "'";
	if(isset($_GET['category_id']))
	{
            ...
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <div class="portfolio-links">
                  <a href="displaysalesdetailed.php?productid=<?php echo $rs[0]; ?>" title="More Details" class="btn btn-danger"><i class="bx bx-link"></i> View More</a>
                </div>
              </div>
            </div>
          </div>
