      ...
      <div class="container">
		...
		<br><br>
          <h3><?php
			...
			{
				echo "Artist's Market Category";
				}
				else
				{
				echo "Art kit Category";
				}
				?></h3>
        </div>
    ...
    <section id="contact" class="contact">
      <div class="container">
		...
		<center><h4> <?php
							if($_GET['cattype']=="Produce")
							{
								echo "View or Delete Artist's Market Category";
                                }
                                else
                                {
                                echo "View or Delete Art kit Category";
                                }
                                ?></h4></center><hr>
...
<tr>
  ...
  while($rs = mysqli_fetch_array($qsql))
  {
							  ...
							  <tr>
							   ...
							   <td><img src='imgcategory/$rs[img]' width='25' height='25'>
								</td>
							    <td>&nbsp;$rs[status]</td>
								 <td>&nbsp; <a href='category.php?editid=$rs[category_id]&cattype=$rs[category_type]&cattype=$_GET[cattype]' class='btn btn-info'>Edit</a> <hr> 
