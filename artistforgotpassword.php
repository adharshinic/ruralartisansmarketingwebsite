...
{
	$sql = "SELECT * FROM artist WHERE email_id='$_POST[emailid]' ";
...
$message = "Hello $rslogin[artist_name], \n your password is : $rslogin[password]";
$headers = "From: $from";
...
<div class="row">
	...
	<input type="submit" name="submit" id="submit" value="Recover Password" class="btn btn-danger">
	</div>	
</div>
</form>
          </p>
