...
<form method="post" action="" name="frmcstlogin">
                  <h4>Login Panel</h4>
...
<a href="customerforgotpassword.php">Forgot Password?</a>
	...
	<button type="button" name="submitotp" id="submitotp" class="btn btn-danger btn-lg btn-block" onclick="return validatecstlogin()" >Click here to Login</button>
	<?php } else { ?>
	<button type="submit" name="submit" id="submit" class="btn btn-danger btn-lg btn-block" onclick="return validatecstlogin()" >Click here to Login</button>
	<?php } ?>
	<script>
