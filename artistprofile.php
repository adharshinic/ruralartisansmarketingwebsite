...
{
		$sql ="UPDATE artist SET artist_name='$_POST[artistname]', artist_address='$_POST[artistaddress]', state_id='$_POST[state]', country_id='$_POST[country]', city_id='$_POST[city]', pincode='$_POST[pincode]', contact_number='$_POST[contactnumber]', mobile_no='$_POST[mbnumber]', email_id='$_POST[emailid]', bank_name='$_POST[bankname]', bank_branch='$_POST[branch]', bank_IFSC='$_POST[ifsccode]', bank_acno='$_POST[bankacnumber]', status='Active' WHERE artist_id='$_SESSION[artistid]'";
...
if(isset($_SESSION['artistid']))
{
	$sql = "SELECT * FROM artist WHERE artist_id='$_SESSION[artistid]'";
...
<div class="form-row">
	...
	<div class="col-md-6 form-group">
	IFSC or NEFT Code  <font color="#FF0000">*</font>
...
<hr>
<button type="submit" name="submit" id="submit" class="btn btn-danger btn-lg btn-block" >Click here to Update Profile</button>
...
$(document).ready( function () {
	...
	<script type="application/javascript">
      function validatesellprofile()
	  {
		  ...
		  if(document.frmsellprofile.artistname.value == "")
		  {
			alert("artist name should not be empty..");
			document.frmsellprofile.artistname.focus();
			return false;
		  }
		  else if(!document.frmsellprofile.artistname.value.match(alphaspaceExp))
		{
			alert("Please enter only letters for artist name..");
			document.frmsellprofile.artistname.focus();
			return false;
		}
			  else if(document.frmsellprofile.artistaddress.value == "")
		  {
			alert("artist address should not be empty..");
			document.frmsellprofile.artistaddress.focus();
			return false;
		  }
