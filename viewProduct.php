  ...
  <main id="main">
    ...
    <section id="cta" class="cta">
      <div class="container">
		...
		<br><br>
          <h3>View Artist's Market Products</h3>
        </div>
    ...
    <section id="contact" class="contact">
      <div class="container">
		...
		<center><h4>View Artist's Market Products...</h4></center><hr>
...
<?php
						$sql = "SELECT * FROM product ";
						    ...
						    <tr>
						      ...
						      <td>&nbsp;$rs[status]</td>
							   <td><center><a href='Product.php?editid=$rs[product_id]' class='btn btn-info'>Edit</a> <br> <a href='viewProduct.php?deleteid=$rs[product_id]' onclick='return delconfirm()' class='btn btn-danger'>Delete</a></center></td>
					        </tr>";
							  }
							  ?>
								</TBODY>
