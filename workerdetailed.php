...
<a href="workerrequest.php?workerid=<?php echo $_GET['workerid']; ?>" class="btn btn-primary btn-plan-select"><i class="icon-white icon-ok"></i> Send Request </a>
                        <?php
						  ...
						  {
						?>
<a href="artistloginpanel.php?redirectlink=<?php echo "workerrequest.php"; ?>&workerid=<?php echo $_GET['workerid']; ?>" class="btn btn-primary btn-plan-select"><i class="icon-white icon-ok"></i> Login & Send Request </a>                          
    	                  <?php
						  }
						  ?>
