...
{
	$loginid 	= "zimcrafts@2kdrivingschool.online";
	$password 	= "4SR.@BHsnKiy";
	$smtpserver = "mail.2kdrivingschool.online";
	$smtpport 	= 587;
	$mailsender = "krishibazaar";
	$companyname= "krishibazaar";
	$facebook = "https://www.facebook.com/krishibazaar";
	$twitter = "https://www.twitter.com/krishibazaar";
	$youtube = "https://www.youtube.com/krishibazaar";
	$linkedin = "https://www.linkedin.com/krishibazaar";
	$companyaddress  = "krishibazaar.com";
	$contactno = "7894561230";
	$url = "www.krishibazaar.com";
