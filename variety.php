...
if($_SESSION['randnumber']  == $_POST['randnumber'])
{
	if(isset($_POST['submit']))
	{
		...
		{
			$sql ="UPDATE variety SET  `category_id`='$_POST[category]', `produce_id`='$_POST[produce]', `variety`='$_POST[variety]', `description`='$_POST[description]'";
			if($_FILES['img']['name'] != "")
			{
			$sql = $sql . ", `img`='$imgname1'";
			}
			$sql = $sql . ", `status`='Active' WHERE  variety_id='$_GET[editid]'";
  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
      <div class="container">
		...
		<center><h4><?php echo " <h2>Add or Edit Variety</h2>"; ?></h4></center><hr>
...
<div class="form-row">
	...
	Image <font color="#FF0000">*</font>
	  <input type="file" name="img" id="img" class="form-control">
		...
		if(isset($_GET['editid']))
		{
			if(file_exists("imgvariety/".$rsedit['img']))
			{
				echo "<img src='imgvariety/".$rsedit['img'] ."' style='height: 150px;'>";
...
function validatevariety()
{
	...
	else if(document.frmvariety.img.value == "" && document.frmvariety.imgset.value == 0)
	{
