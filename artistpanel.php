...
{
	echo "<script>window.location='artistloginpanel.php';</script>";
}
if(isset($_SESSION['artistid']))
{
	...
	<table class="table table-striped table-bordered" style="width:100%" class="datatable">
	  <tbody>
		<tr>
							      ...
							      <td width="874"><?php echo $rsdisp['artist_name']; ?></td>
						        </tr>
							    <tr>
                                 ...
                                 <?php
								  ...
								  <td>
								 <?php echo $rsdisp['artist_address']; ?><br />
...
<tr><th>Bank IFSC or NEFT Code:</th><td><?php echo $rsdisp['bank_IFSC']; ?></td></tr>
        ...
        <div class="row">
          ...
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="100">
            <div class="info mt-4">
                ...
                $start_year=date('Y')-5; // Starting year for dropdown list box
                ...
                $sqlworkrq = "SELECT * FROM  worker_request WHERE ( '$dtmnyr' BETWEEN  from_date AND  to_date) AND  artist_id='$_SESSION[artistid]' "; 
