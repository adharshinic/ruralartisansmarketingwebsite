...
<?php
							...
							<table ID="datatable" class="table table-striped table-bordered"  style="width:100%">
							  ...
							  <tr>
							    ...
							    <td>&nbsp;$rs[address],<br>&nbsp;$rs1[country],<br>&nbsp;$rs2[state],<br>&nbsp;$rs3[city]<br>PIN code: &nbsp;$rs[pincode]</td>
							    <td>&nbsp;$rs[contact_no]</td>
							    <td>&nbsp;$rs[mobile_no]</td>
							    <td>&nbsp;$rs[customer_type]</td>
							    <td>&nbsp;$rs[status]</td>
							    <td><a href='customerReg.php?editid=$rs[customer_id]' class='btn btn-danger' style='width: 100%;' >Edit</a> <a href='viewcustomerReg.php?deleteid=$rs[customer_id]' onclick='return delconfirm()' class='btn btn-danger'  style='width: 100%;' >Delete</a></td>
						      </tr>";
							  }
							  ?>
								</TBODY>
