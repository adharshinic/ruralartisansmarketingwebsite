  ...
  <main id="main">
    ...
    <section id="cta" class="cta">
      <div class="container">
		...
		<br><br>
          <h3>Artist's Product Purchase Bill Report</h3>
        </div>
...
{
$sqlbill = $sqlbill . " WHERE purchase_order.artist_id='$_SESSION[artistid]' ORDER BY purchase_order_bill_id DESC";
}
...
echo mysqli_error($con);
							if(mysqli_num_rows($qsqlbill)  == 0)
									{
										echo "<center>There is no Purchase Records to display!!</center>";
									}
									else
									{
										?>
	<table ID="datatable" class="table table-striped table-bordered"  style="width:100%">
	  ...
	  while($rsbill = mysqli_fetch_array($qsqlbill))
	  {
			...
			<tr>
			  ...
			  <td>&nbsp;$usdsymbol $rsbill[paid_amt]</td>
