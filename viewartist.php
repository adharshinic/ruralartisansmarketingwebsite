...
{
	$sql = "DELETE FROM artist WHERE artist_id='$_GET[deleteid]'";
  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
      <div class="container">
		...
		<center><h4>Registered Artists list...</h4></center><hr>
...
<?php
							 $sql = "SELECT * FROM artist";
							  ...
							  if(mysqli_num_rows($qsql)  == 0)
									{
										echo "<center>There is no artist to display!!</center>";
									}
									else
									{
							?>
...
<?php
						    ...
						    <tr>
							  ...
							  <strong>IFSC or NEFT Code:</strong>&nbsp;$rs[bank_IFSC],<br>"."
							  <strong>Bank Name:</strong>&nbsp;$rs[bank_name],<br>"."
						      <strong>Branch:</strong>&nbsp;$rs[bank_branch].
						     </td>
						      <td>&nbsp;$rs[status]</td>
						      <td>&nbsp;  <a href='artist.php?editid=$rs[artist_id]' class='btn btn-info'>Edit</a><br><a href='viewartist.php?deleteid=$rs[artist_id]' onclick='return delconfirm()' class='btn btn-danger'>Delete</a></td>
					        </tr>";
							  }
							  ?>
								</TBODY>
