...
<li data-filter="*" class="filter-active">Jobs in Arts industry leading art jobs near you. </li>
            </ul>
          </div>
        </div>
...
<span id='loadcity'><select name="city"  autofocus class="search_categories form-control"><option value="">Select City</option></select></span>
       ...
       <center>
	   <input type="submit" name="submit" id="submit" value="Search" class="btn btn-danger"><br><a href="displayworkers.php">Clear Search</a></center>
                </div>
              </div>
            </div>
</form>
	  ...
	  <div class="col-lg-4">
		<div class="member" data-aos="zoom-in" data-aos-delay="100">
		  ...
		  <div class="member-info">
			...
			<hr>
			<div >
			  <a href="workerdetailed.php?workerid=<?php echo $rs['worker_id']; ?>" class="btn btn-danger">View More</a>
			</div>
		  </div>
		</div>
	  </div>
