  ...
  <main id="main">
    ...
    <section id="cta" class="cta">
      <div class="container">
		...
		<br><br>
          <h3>Artist's Craft Purchase Request</h3>
        </div>
...
<tr>
  ...
  while($rs = mysqli_fetch_array($qsql))
  {
						    ...
						    <tr>
							 ...
							 {
							  echo "<a href='viewpurchaserequest.php?deleteid=$rs[purchase_request_id]' onclick='return delconfirm()' class='btn btn-danger'>Delete</a>";							  
							 }
							  echo "</td></tr>";
  }
  ?>
