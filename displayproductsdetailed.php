    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Artist Kit Product Details</h2>
          <ol>
...
?>	
	...
	{
	?>
              <li><a href="displaycart.php?prodid=<?php echo $rs[0]; ?>&prodcost=<?php echo $rs['cost']; ?>" class="btn btn-danger">Add to Cart</a></li>
    <?php
	}
	else
	{
	?>   
              ...
              <li><a href="artistloginpanel.php?pagename=<?php echo basename($_SERVER['PHP_SELF']); ?>&productid=<?php echo $_GET['productid']; ?>" class="btn btn-warning" style="width: 100%;">Login as artist</a></li>
	<?php
	}
	?>
            </ul>
