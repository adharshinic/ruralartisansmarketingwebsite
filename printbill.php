              ...
              <div class="col-lg-6">
                <div class="info w-100 mt-4">
                  ...
                  <h4>Billing detail:</h4>
				          <p><b>Bill No. :</b> <?php echo $rs['product_purchase_bill_id']; ?></p>
				          <p><b>Date of Bill :</b> <?php echo date("d-m-Y",strtotime($rs['purchase_date'])); ?></p>
                  <p><b>Name :</b> <?php echo $rs['customer_name']; ?></p>
                  <p><b>Ph. No.</b> <?php echo $rs['customer_contact_number']; ?></p>
                  <p><b>Payment Type:</b> <?php echo $rs['payment_type']; ?></p>
                </div>
              </div>
...
<table width="755" border="0" class="table table-bordered">
  <tbody>
    ...
    <tr>
      ...
      <th>&nbsp; <?php echo $usdsymbol; ?> <?php echo $tot; ?></th>
    </tr>
  </tbody>
</table>
<hr>
