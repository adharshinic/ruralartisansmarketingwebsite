        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="section-title" data-aos="fade-right">
              <h2>Customer Login/Register</h2>
              <p>Login as Customer/Buyer - Buy Sculptures, Antiques, Paintings, etc directly from Artists... </b></p>
            </div>
          </div>
          <div class="col-lg-8">
            <div class="row">
              ...
              <div class="col-md-6 d-flex align-items-stretch">
                <div class="icon-box" data-aos="zoom-in" data-aos-delay="100" style="width: 100%;">
				  ...
				  <button type="button" class="btn btn-danger btn-lg btn-block" onclick="window.location='customerloginpanel.php'">Sign In  & Get Started</button>
                </div>
              </div>
