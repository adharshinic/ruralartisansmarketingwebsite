        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="section-title" data-aos="fade-right">
              <h2>Worker Login/Register</h2>
              <p>Are you Looking for employment opportunities?<br> <b>Login / Register as Worker</b></p>
            </div>
          </div>
          <div class="col-lg-8">
            <div class="row">
              ...
              <div class="col-md-6 d-flex align-items-stretch">
                <div class="icon-box" data-aos="zoom-in" data-aos-delay="100" style="width: 100%;">
				  ...
				  <button type="button" class="btn btn-danger btn-lg btn-block" onclick="window.location='workerloginpanel.php'">Sign In  & Get Started</button>
                </div>
              </div>
