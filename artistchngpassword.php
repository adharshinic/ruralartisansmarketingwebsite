...
{
	$sql = "UPDATE artist SET password='$_POST[newpassword]' WHERE artist_id='$_SESSION[artistid]' AND password='$_POST[oldpassword]'";
...
<hr>
<button type="submit" name="submit" id="submit" class="btn btn-danger btn-lg btn-block" >Change Password</button>
