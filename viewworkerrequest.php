...
<?php
		  ...
		  if(isset($_SESSION['artistid']))
			{
				$sql = $sql . " WHERE artist_id='$_SESSION[artistid]' ORDER BY worker_request_id DESC";
			}
...
Farmer - &nbsp;$rsartist[artist_name]</td>								
...
$date2 = new DateTime($rs['to_date']); 
								   ...
								   echo "<a href='viewworkerrequestdetailed.php?viewid=$rs[worker_request_id]' class='btn btn-danger' style='width: 100%;'>View</a></td></tr>";
									}
								   ...
								   echo "<a href='viewworkerrequest.php?deleteid=$rs[worker_request_id]' onclick='return delconfirm()' class='btn btn-danger'>Delete</a> | <a href='viewworkerrequestdetailed.php?viewid=$rs[worker_request_id]' class='btn btn-danger'>View</a></td></tr>";
									}
							  }
							  ?>
								</TBODY>
