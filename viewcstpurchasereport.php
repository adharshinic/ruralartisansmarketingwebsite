<?php 
include("header.php");
if($_SESSION['customerid'] != "" && $_SESSION['artistid'] != "")
{
...
<?php
	  ...
	  {
	  $sql = "SELECT * FROM product_purchase_bill where artist_id='$_SESSION[artistid]' ORDER BY product_purchase_bill_id DESC ";
	  }
												  ...
												  while($rs = mysqli_fetch_array($qsql))
												  {
														  ...
														  $rssum = mysqli_fetch_array($qsqlsum);
													 		echo "<tr>
														  			...
														  			<td>$usdsymbol " . $rssum[0]  . "</td>
														  			<td>$rs[status]</td>
														  			<td><a href='printbill.php?billid=$rs[0]' class='btn btn-danger'>View Bill</a></td>
															</tr> ";
												  }
										  ?>
										  </tbody>
