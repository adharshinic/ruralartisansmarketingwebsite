...
<div class="form-row">
	...
	Customer Type <font color="#FF0000"> *</font>
	  <select name="customertype" id="customertype" class="form-control" >
		  <option value="">Select</option>
		  <?php
		 	$arr= array("Trophy Hunters","Home Collectors","Investors", "Gallery Collectors", "Interior Designers");
		  foreach($arr as $val)
		  {
...
<hr>
<button type="submit" name="submit" id="submit" class="btn btn-danger btn-lg btn-block" >Update Profile</button>
