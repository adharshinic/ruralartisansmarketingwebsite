        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="section-title" data-aos="fade-right">
              <h2>Artist Login/Register</h2>
              <p>Online platform links Artists to buyers Buy and sell your artworks online free (Buyers meet Artists) - sell or buy artworks online....<br></p>
            </div>
          </div>
          <div class="col-lg-8">
            <div class="row">
              ...
              <div class="col-md-6 d-flex align-items-stretch">
                <div class="icon-box" data-aos="zoom-in" data-aos-delay="100" style="width: 100%;">
                  ...
                  <h4><a href="artistloginpanel.php">Existing Artists</a></h4>
				        
				  <button type="button" class="btn btn-danger btn-lg btn-block" onclick="window.location='artistloginpanel.php'">Sign In  & Get Started</button>
                </div>
              </div>
