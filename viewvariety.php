...
if(isset($_GET['deleteid']))
{
	...
	else
	{
		...
		echo "<script>window.location='viewvariety.php?varietytype=Produce';</script>";
		}
	}
}
?>
  <main id="main">
    ...
    <section id="contact" class="contact">
      <div class="container">
		...
		<center><h4><?php echo "View ". $_GET['varietytype']." Variety"; ?> list...</h4></center><hr>
...
<?php
						    ...
						    <tr>
						      ...
						      <td>&nbsp;$rs[4]</td>
						       <td>&nbsp;
								<img src='imgvariety/$rs[5]' width='75' height='75'>
								</td>
						      <td>&nbsp;$rs[status]</td>
							  <td><a href='variety.php?editid=$rs[variety_id]' CLASS='btn btn-danger' style='width: 100%'>Edit</a> <a href='viewvariety.php?deleteid=$rs[variety_id]' onclick='return delconfirm()' CLASS='btn btn-danger' style='width: 100%'>Delete</a></td>
					        </tr>";
							  }
							  ?>
								</TBODY>
