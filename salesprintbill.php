    ...
    <section id="contact" class="contact">
      <div class="container">
        <div class="row">
          ...
          <center><h1 class="text-light"><a href="index.php"><span>ZimCrafts</span></a></h1></center>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="info w-100 mt-4">
				  ...
				  <p style="padding: 0 0 0 0px;"><b>Paid Date:</b> <?php echo date("d-m-Y",strtotime($rsbill['paid_date'])); ?></p>
                  <p style="padding: 0 0 0 0px;"><b>Customer Name:</b> <?php echo $rscustomer['customer_name']; ?></p>
                  <p style="padding: 0 0 0 0px;"><b>artist Name:</b> <?php echo $rscustomer['artist_name']; ?></p>
                </div>
              </div>
              ...
              <div class="col-md-4 mt-4">
                <div class="info">
                  ...
                  <p>
                  		<?php echo $rsartist['artist_address']; ?> <br>
                      <?php echo $rsselcity['city']; ?> <br>
                      <?php echo $rsselstate['state']; ?> <br>
                      <?php echo $rsselcountry['country']; ?> <br>
                      PIN Code: <?php echo $rsartist['pincode']; ?><br>
					  					Ph. No. <?php echo $rsartist['mobile_no']; ?></p>
                </div>
              </div>
            </div>
...
<table width="755" border="0" class="table table-bordered">
  <tbody>
    ...
    <tr>
      ...
      <th>&nbsp; <?php echo $usdsymbol; ?> <?php echo $rspurchase_order['purchase_amt']; ?></th>
...
<table width="755" border="0" class="table table-bordered">
				            <tbody>
				              <tr>
				                ...
				                <td width="514" height="31" scope="row" align="left">&nbsp;<?php echo $rsbill['payment_type']; ?></td>
			                  </tr>
				              
				              <tr>
				                <th height="33" scope="row" align="right">&nbsp;<strong>Paid Date:</strong></th>
				                <td align="left">&nbsp; <?php echo date("d-m-Y",strtotime($rsbill['paid_date'])); ?></td>
			                  </tr>
				              ...
				              <tr>
				                ...
				                <td align="left">
															<?php
                                echo "<strong> &nbsp;Bank Name: </strong> ". $rsartist['bank_name'] . "<br>";
                                echo "<strong> &nbsp;Bank Account number: </strong> " .$rsartist['bank_acno'] . "<br>";
                                echo "<strong> &nbsp;Branch: </strong> ".$rsartist['bank_branch'] . "<br>";
                                echo "<strong> &nbsp;IFSC Code: </strong> ". $rsartist['bank_IFSC'] . "<br>";			
															?>
                                </td>
			                  </tr>
			                </tbody>
