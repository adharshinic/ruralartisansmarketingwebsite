      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="100">
            <div class="info mt-4 ">
						<center><h4>View EXHIBITION DETAILS...</h4></center><hr>
						<?php
				  	...
				  	$qsql = mysqli_query($con,$sql);
						...
						?>
								<table ID="datatable" class="table table-striped table-bordered"  style="width:100%">
										<THEAD>
										  <tr>
										    <th><strong>EXHIBITION Type</strong></th>
			              ...
			              <?php
									  while($rs = mysqli_fetch_array($qsql)) {
										  ...
										  <tr>
										    ...
										    <td>&nbsp;$rs[title]</td>
										    <td>";
										    if(file_exists("imgarticle/$rs[article_img1]")) {
										    	echo "<img src='imgarticle/$rs[article_img1]' width='25' height='25'>";
										    }
										    if(file_exists("imgarticle/$rs[article_img2]")) {
												echo "<img src='imgarticle/$rs[article_img2]' width='25' height='25'>";
												}
												if(file_exists("imgarticle/$rs[article_img3]")) {
												echo "<img src='imgarticle/$rs[article_img3]' width='25' height='25'>";
												}	
												if(file_exists("imgarticle/$rs[article_img4]")) {
										    echo "<img src='imgarticle/$rs[article_img4]' width='25' height='25'>";
										  	}
										  	if(file_exists("imgarticle/$rs[article_img5]")) {
												echo "<img src='imgarticle/$rs[article_img5]' width='25' height='25'>";
												}
												echo "</td><td>&nbsp;<a href='article.php?editid=$rs[article_id]' CLASS='btn btn-info '>Edit</a>&nbsp;<a href='viewarticle.php?deleteid=$rs[article_id]' onclick='return delconfirm()' CLASS='btn btn-danger'>Delete</a></td>
									      </tr>";
									  }
									  ?>
										</TBODY>
