...
<?php
	  ...
	  $sql1 = "SELECT * FROM country WHERE country_id='$rs[country_id]'";
						    ...
						    <tr>
						      ...
						      <td>&nbsp;$rs[login_id]</td>
						      <td>&nbsp;$usdsymbol" . intval($rs['expected_salary']) . "</td>
						      <td><a href='worker.php?editid=$rs[worker_id]' class='btn btn-danger' style='width: 100%;'>Edit</a> <hr>
							  <a href='viewworker.php?deleteid=$rs[worker_id]' onclick='return delconfirm()' class='btn btn-danger' style='width: 100%;'>Delete</a><hr>
