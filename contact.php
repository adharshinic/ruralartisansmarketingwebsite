...
{
	$to = "tmudhara8@gmail.com";
	$subject = "Message from ZimCrafts";		
	$message = "<html>
	<head>
	<title>ZimCrafts Contact Us form</title>
	</head>
	<body>
	<p>ZimCrafts Contact Us form</p>
	<table>
	<tr>
	<th>Name</th>
	<td>$_POST[name]</td>
	...
	sendmail($to, "ZimCrafts" , $subject, $message);
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="100">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d995397.3458225038!2d76.9727283223709!3d12.954510587081241!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae1670c9b44e6d%3A0xf8dfc3e8517e4fe0!2sBengaluru%2C%20Karnataka!5e0!3m2!1sen!2sin!4v1684601211828!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            <div class="info mt-4">
            ...
            <form action="" method="post" role="form" class="mt-4">
              ...
              <div class="text-center"><input type="submit" class="btn btn-danger" name="submit" id="submit" value="Send Message"></div>
            </form>
          </div>
        </div>
